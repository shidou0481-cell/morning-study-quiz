...
湖・海|瀬戸内海|本州・四国・九州の間|雨が少なく、おだやかな海|325,270`.split('\n').map(x=>{const [category,place,answer,explain,pos]=x.split('|');return{era:'地理',category,place,answer,explain,pos,level:2,type:'choice',kind:'白地図・地理',text:`白地図の★が示す${category}は何ですか。`,mapOnly:true}});
  ...
  function mapSVG(q){if(!q.pos)return '';const markers={
    '蝦夷地':'69,18','函館':'61,27','江戸':'57,51','東京':'57,51','鎌倉':'56,54','浦賀':'57,55','横浜':'56,53','京都':'45,58','平安京':'45,58','室町':'45,58','安土':'47,58','飛鳥地方':'46,62','平城京':'46,62','大阪':'43,63','広島':'34,66','下関':'27,68','長崎':'18,77','吉野ヶ里遺跡':'22,75','沖縄':'15,90',
    '日高山脈':'71,20','奥羽山脈':'58,37','越後山脈':'50,45','飛騨山脈':'47,51','木曽山脈':'47,56','赤石山脈':'51,56','中国山地':'34,62','石狩平野':'65,23','仙台平野':'58,41','関東平野':'57,51','濃尾平野':'45,59','大阪平野':'43,63','岡山平野':'35,65','筑紫平野':'22,74','石狩川':'66,22','北上川':'58,37','利根川':'58,51','信濃川':'50,45','木曽川':'45,59','天竜川':'51,57','吉野川':'42,70','四万十川':'35,76','筑後川':'22,75','琵琶湖':'47,59','霞ヶ浦':'60,50','宍道湖':'31,62','東京湾':'58,54','有明海':'20,77','瀬戸内海':'36,68'};
    ...
    return `<div class="map-card"><div class="map-wrap"><img class="map-base" src="japan-map.svg" alt="都道府県境が入った日本の白地図"><span class="map-pin" style="left:${left}%;top:${top}%" aria-label="問題の地点">★</span></div><div class="mini">都道府県境と列島の形を見て、★の場所を答えよう</div><div class="mini">地図素材: Geolonia Japanese Prefectures（GFDL）</div></div>`}
